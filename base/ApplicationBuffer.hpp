// trivial
// Created by kiki on 2021/11/15.18:39
#pragma once
#include <vector>
#include <array>
#include <string>
...
private:
	vector<char> buffer;
	size_t readable_index {reserved}; // vector扩容后会使迭代器失效，此处不能记录指针。
	size_t writable_index {reserved};
...
public:
	ssize_t ReadFromFd(int fd) //返回从fd中读到的字节数，最多读取128k数据
	{
